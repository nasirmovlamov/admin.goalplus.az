  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
        <span className="font-semibold">Admin Adminov</span>
        <span className="text-sm text-gray-600">Freelance Adminer</span>
      </div>
      <span className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSHtMbcSpcffD-iHzWQy-CRDDYNlmw0sjOZ8hxn5eeFuPaP-ICYmTtyfKtJBtBwGtLGGsc&usqp=CAU"
      ...
      {userMenuStatus && (
        <div className="absolute right-0 sm:-bottom-16 bg-slate-500 px-2 py-1 space-x-2 text-yellow-50 w-full -bottom-28">
          <a className="block hover:bg-gray-50 hover:text-black">section 1</a>
          <a className="block hover:bg-gray-50 hover:text-black">section 2</a>
        </div>
      )}
